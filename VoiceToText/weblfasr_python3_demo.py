...
if __name__ == '__main__':
    x_appid='5e0ada8e'
    x_secret_key='d100ae2fd9ca6d67e882c3b3199a19b6'

    api = RequestApi(appid=x_appid, secret_key=x_secret_key, upload_file_path=r"C:\Users\xh-huang\Documents\Python\VoiceToText\test.wav")
    api.all_api_request()
